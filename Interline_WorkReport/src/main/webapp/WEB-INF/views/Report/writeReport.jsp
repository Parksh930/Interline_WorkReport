...
-->
<script src="http://192.168.1.34:8888/oz80/ozhviewer/jquery.mouseSwipe.js" type="text/javascript"></script>
...
<script type="text/javascript" >
	function SetOZParamters_OZViewer(){
		...
		oz.sendToActionScript("connection.servlet","http://192.168.1.34:8888/oz80/server");
		oz.sendToActionScript("viewer.showpagemargin","false");
		oz.sendToActionScript("eform.functionbutton_display_type","alwayshide");
		oz.sendToActionScript("connection.reportname","OSA/phonetest.ozr");
	...
	start_ozjs("OZViewer","http://192.168.1.34:8888/oz80/ozhviewer/", true);
